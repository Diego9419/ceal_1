...
if(empty($_REQUEST['id']) || $_REQUEST['id']==3 || $_REQUEST['id']==11 || $_REQUEST['id']==12 ){
    header("location: lista_usuarios.php");
...
<section id="container">
    <div class= "data_delete">
       ...
       <p class= "text">Usuario:<span><?php echo $usuario; ?></span></p>
       <p class= "text">Rol:<span><?php echo $rol; ?></span></p>
